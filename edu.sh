...
wget -q -O /usr/local/bin/edussh-nontls https://raw.githubusercontent.com/kenDevXD/0/main/proxy-template.py
...
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/kenDevXD/0/main/edu-op.py

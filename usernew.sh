...
echo -e "Port SSH WS HTTP    : 2082"
echo -e "Port SSH WS HTTPS   : 443"
...
echo -e "==============================="
echo -e "PAYLOAD SSH WS SSL:"
echo -e "GET wss://isibug HTTP/1.1[crlf]Host: ${domain}[crlf]Upgrade: websocket[crlf][crlf]"
echo -e "==============================="
